...
async function getTop10Characters () {
  ...
  await prisma.$queryRaw`SELECT 
	sa."CharacterId", c."Name" , c."CharacterClassId" ,
    ...
    MAX(CASE WHEN sa."DefinitionId"  = '70cd8c10-391a-4c51-9aa4-a854600e3a9f' THEN sa."Value"  ELSE 0 END) AS masterlvl
  	,(SELECT gu."Name"
	  from guild."GuildMember"
	  JOIN guild."Guild" gu on gu."Id" = guild."GuildMember"."GuildId"
	  WHERE guild."GuildMember"."Id" = sa."CharacterId"
	  limit 1) as Guild
  FROM 
